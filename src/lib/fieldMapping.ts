...
export const MAPPABLE_FIELDS: { path: string; label: string }[] = [
  ...
  { path: 'productLink',                label: 'Product Link'                     },
  { path: 'unit',                       label: 'Unit'                             },
  { path: 'material',                   label: 'Material'                         },
  // ── Geometry ──────────────────────────────────────────────────────────────
  { path: 'geometry.diameter',          label: 'Geometry — Diameter'              },
  { path: 'geometry.shaftDiameter',     label: 'Geometry — Shaft Diameter'        },
  { path: 'geometry.fluteLength',       label: 'Geometry — Flute Length'          },
  { path: 'geometry.bodyLength',        label: 'Geometry — Body Length'           },
  { path: 'geometry.shoulderLength',    label: 'Geometry — Shoulder Length'       },
  { path: 'geometry.overallLength',     label: 'Geometry — Overall Length'        },
  { path: 'geometry.numberOfFlutes',    label: 'Geometry — # Flutes'              },
  { path: 'geometry.numberOfTeeth',     label: 'Geometry — # Teeth'               },
  { path: 'geometry.cornerRadius',      label: 'Geometry — Corner Radius'         },
  { path: 'geometry.taperAngle',        label: 'Geometry — Taper Angle'           },
  { path: 'geometry.pointAngle',        label: 'Geometry — Point Angle'           },
  { path: 'geometry.tipDiameter',       label: 'Geometry — Tip Diameter'          },
  { path: 'geometry.tipLength',         label: 'Geometry — Tip Length'            },
  { path: 'geometry.shoulderDiameter',  label: 'Geometry — Shoulder Diameter'     },
  { path: 'geometry.threadPitch',       label: 'Geometry — Thread Pitch'          },
  { path: 'geometry.threadProfileAngle',label: 'Geometry — Thread Profile Angle'  },
  { path: 'geometry.profileRadius',     label: 'Geometry — Profile Radius'        },
  { path: 'geometry.nozzleDiameter',    label: 'Geometry — Nozzle Diameter'       },
  // ── Cutting parameters ────────────────────────────────────────────────────
  { path: 'cutting.spindleRpm',         label: 'Cutting — Spindle RPM'            },
  { path: 'cutting.rampSpindleRpm',     label: 'Cutting — Ramp Spindle RPM'       },
  { path: 'cutting.feedCutting',        label: 'Cutting — Feed (Cut)'             },
  { path: 'cutting.feedPlunge',         label: 'Cutting — Feed (Plunge)'          },
  { path: 'cutting.feedRamp',           label: 'Cutting — Feed (Ramp)'            },
  { path: 'cutting.feedEntry',          label: 'Cutting — Feed (Entry)'           },
  { path: 'cutting.feedExit',           label: 'Cutting — Feed (Exit)'            },
  { path: 'cutting.feedRetract',        label: 'Cutting — Feed (Retract)'         },
  { path: 'cutting.coolant',            label: 'Cutting — Coolant'                },
  { path: 'cutting.feedMode',           label: 'Cutting — Feed Mode'              },
  // ── NC properties ─────────────────────────────────────────────────────────
  { path: 'nc.breakControl',            label: 'NC — Break Control'               },
  { path: 'nc.diameterOffset',          label: 'NC — Diameter Offset'             },
  { path: 'nc.lengthOffset',            label: 'NC — Length Offset'               },
  { path: 'nc.liveTool',                label: 'NC — Live Tool'                   },
  { path: 'nc.manualToolChange',        label: 'NC — Manual Tool Change'          },
  { path: 'nc.turret',                  label: 'NC — Turret'                      },
  // ── Offsets ───────────────────────────────────────────────────────────────
  { path: 'offsets.x',                  label: 'Offset X'                         },
  { path: 'offsets.y',                  label: 'Offset Y'                         },
  { path: 'offsets.z',                  label: 'Offset Z'                         },
  { path: 'offsets.a',                  label: 'Offset A'                         },
  { path: 'offsets.b',                  label: 'Offset B'                         },
  { path: 'offsets.c',                  label: 'Offset C'                         },
];
